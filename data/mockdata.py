...
def generate_mock_data() -> pd.DataFrame:
    ...
    for obchod_id in range(1, num_stores + 1):
        ...
        dostupnost_zbozi = round(random.uniform(85, 100), 2) if zmena_oproti_predeslemu_tydnu > 0 else round((100 + (45*zmena_oproti_predeslemu_tydnu/100)), 2)
        dostupnost_personal = round(random.uniform(90, 100), 2) if zmena_oproti_predeslemu_tydnu > 0 else round((100 + (35*zmena_oproti_predeslemu_tydnu/100)), 2)
